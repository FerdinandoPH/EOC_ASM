.section .data
    ...
    #argumentos_sonido
        ...
        argumentsT2: .long command_string, argument1, argument2, 0
        argumentsT1: .long command_string, argument1, argument3, 0
        argumentsInit: .long command_string, argument1, argument4, 0
        argumentsSox: .long command_string, argument1, argument5, 0
        .global musID
        musID: .long 0
